...
#define GRASP_EXPERIMENT_NAME "data_insert_06_03_2012_grasp"
#define PLACE_EXPERIMENT_NAME "data_insert_06_03_2012_insert"
...
int main(int argc, char** argv)
{
  ...
  matlab.sendCommand("DataInsert_Init();");
  ...
  while (ros::ok())
  {
    ...
    else
    {
      ...
      */
        ...
        matlab.sendCommand("[bestParams, mapParams, probSuccess] = DataInsert_ComputeParams(encoderVals);");
...
*/
    ...
    ROS_INFO("DATA_DROP: (S = %d, N = %d, %2.3f%%, I = %d)", singulated, i-singulated, (100.0*singulated)/i, ignored);
    ROS_INFO("DATA_DROP: (Ppred = %f, Preal= %f)", runningProbability, ((double)inserted)/(singulated-ignored));
