...
#define GRASP_EXPERIMENT_NAME "data_place_video_grasp"
#define PLACE_EXPERIMENT_NAME "data_place_video_place"
...
*/
  ...
  inserterInParams.type = PM_TYPE_OPENLOOP;
  inserterInParams.v1_dist = 70.0;
  inserterInParams.v2_dist = 60.0;
  inserterInParams.test = false;
