...
int main(int argc, char** argv)
{
  ...
  grasperInParams.handSpeed = 0.5;//0.647368; //0.45;
  ...
  */
  ...
  while (ros::ok())
  {
    ...
    {
      dropperInParams.angle = sensorOutParams.alpha;
      dropperInParams.h_dist = sensorOutParams.distance;
