//DROOP ANGLE ADDED, EARLIER CLOSE ANGLE 70 WAS GOOD FOR DRROPING (MAY BE BECAUSE WE WERE USING LOW POER TO DRIVETHE HAND)
// DROOP ANGLE = 47
...
#define TCPss 20.0   // SuperSlow speed mm / s
...
int main(int argc, char** argv)
{
 ...
 // HomogTransf pose;
  ...
  int Tsleep_F2E= 10040; //1085; //1078; //486000;
  ...
  Vec transPick2=transPick+Vec("0 35 1",3);	//2nd Pick Point
  Vec transPlace2=transPick2+Vec("0 0 114.5",3);	//Place Point
  Vec transPick3=transPlace2+Vec("-7 7 -20",3);	//2nd Pick Point
  ...
  hand.SetAngle(HAND_CLOSE_ANGLE_Droop);
  hand.WaitRest(1);
  ...
  robot.SetSpeed(TCPs, ORIs);
  robot.SetCartesian(transPick3[0], transPick3[1], transPick3[2], quatO[0], quatO[1], quatO[2], quatO[3]);
