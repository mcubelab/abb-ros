//RELEASE ANGLE CHANED FROM MIN ANGLE TO MAX ANGLE 
//CHNAGES MADE IN regrasp_node.cpp
...
int main(int argc, char** argv)
{
  ...
  ros::init(argc, argv, "PushTranslate");
  ros::NodeHandle node;
 ...
 // HomogTransf pose;
  ...
  // (Arguments are == 1 (special command number= # of the regrasp in Special Commands RAPID code), Z at Acc switch, Z at catch, Acc1 till acc switch, Acc2 till catch, Acc3 till stop) 
  ...
  robot.SetJoints(0.0, 0.0, 0.0, 0.0, -20.0, 0.0);
