"""autogenerated by genpy from objRec_comm/objRec_GetObjectRequest.msg. Do not edit."""
import sys
...
class objRec_GetObjectRequest(genpy.Message):
  _md5sum = "1b4292c8a1b43354da04676ef9d1dda9"
  _type = "objRec_comm/objRec_GetObjectRequest"
...
"""
  __slots__ = ['filename','cameraName','onTable']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(objRec_GetObjectRequest, self).__init__(*args, **kwds)
...
"""autogenerated by genpy from objRec_comm/objRec_GetObjectResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class objRec_GetObjectResponse(genpy.Message):
  _md5sum = "b186504864a83ccde76a159b5fa419be"
  _type = "objRec_comm/objRec_GetObjectResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """
int64 objNum
float64[3] trans
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(objRec_GetObjectResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
...
class objRec_GetObject(object):
  _type          = 'objRec_comm/objRec_GetObject'
  _md5sum = '91650f8c373d26a2f3629b3e8c8f5cfe'
  _request_class  = objRec_GetObjectRequest
  _response_class = objRec_GetObjectResponse
