...
#define MAX_FINGER_DEFLECTION 3.0      // Max finger deflection is surface detection (in degrees).

#define HAND_CLOSE_FORCE 0.5
#define HAND_CLOSE_ANGLE 110.0

#define HAND_OPEN_FORCE 0.5
#define HAND_OPEN_SPEED 0.5
